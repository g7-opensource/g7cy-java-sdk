package com.huoyunren.openapi.api.truck;
...
import com.huoyunren.openapi.dto.truck.*;
import com.huoyunren.openapi.dto.truck.TruckCurrentLocationResp;
import com.huoyunren.openapi.enums.truck.GetCountEnum;
import com.huoyunren.openapi.enums.truck.TruckApiEnum;
import com.huoyunren.openapi.util.auth.AssertUtil;
import com.huoyunren.openapi.util.http.G7OpenapiResult;
import com.huoyunren.openapi.util.http.IRequest;
import com.huoyunren.openapi.util.http.RequestContext;
import com.huoyunren.openapi.util.http.RestTemplateRequest;
...
public class G7OpenapiClient {
    ...
    private RequestContext buildContext(TruckApiEnum api) {
    ...
    public List<TruckListInfoResp> truckList(TruckListReq req) {
        RequestContext context = buildContext(TruckApiEnum.TRUCK_LIST);
    ...
    public TruckInfoAndCustomFieldResp truckInfoAndCustomField(TruckInfoCustomReq req) {
        RequestContext context = buildContext(TruckApiEnum.TRUCK_INFO_CUSTOM_FIELDS);
        context.setBody(JSON.toJSONString(req));
    ...
    public Map<String, TruckModelInfoResp> getTruckModelInfo(TruckModelInfoReq req) {
        RequestContext context = buildContext(TruckApiEnum.GET_TRUCK_MODEL_INFO);
        context.setBody(JSON.toJSONString(req));
    ...
    public List<TruckInfoResp> truckInfo(TruckInfoReq req) {
        RequestContext context = buildContext(TruckApiEnum.TRUCK_INFO);
        context.setBody(JSON.toJSONString(req));
    ...
    public List<SimpleCurrentsGpsNoResp> simpleCurrentsGpsNo(SimpleCurrentsGpsNoReq req) {
        RequestContext context = buildContext(TruckApiEnum.SIMPLE_CURRENTS_BY_GPSNOS);
        context.setBody(JSON.toJSONString(req));
    ...
    public Map<String, TruckCurrentInfoBatchResp> truckCurrentInfoBatch(TruckCurrentInfoBatchReq req) {
        RequestContext context = buildContext(TruckApiEnum.TRUCK_CURRENT_INFO_BATCH);
        context.setBody(JSON.toJSONString(req));
    ...
    public SelfTruckAddResp addSelfTruck(SelfTruckAddReq req) {
        RequestContext context = buildContext(TruckApiEnum.ADD_SELF_TRUCK);
        context.setBody(JSON.toJSONString(req));
    ...
    public Map<String, TruckDeleteResp> truckDelete(TruckDeleteReq req) {
        RequestContext context = buildContext(TruckApiEnum.TRUCK_DELETE);
        context.setBody(JSON.toJSONString(req));
    ...
    public SelfTruckUpdateResp updateSelfTruck(SelfTruckUpdateReq req) {
        RequestContext context = buildContext(TruckApiEnum.UPDATE_SELF_TRUCK);
        context.setBody(JSON.toJSONString(req));
    ...
    public GpsNoStatusListResp gpsNoStatusList(GpsNoStatusListReq req) {
        RequestContext context = buildContext(TruckApiEnum.LIST_GPSNO_BY_STATUS_FROM_ORGCODE);
    ...
    public DeviceBindResp bindDevice(DeviceBindReq req) {
        RequestContext context = buildContext(TruckApiEnum.BIND_DEVICE);
        context.setBody(JSON.toJSONString(req));
    ...
    public Map<String, DeviceUnbindRsp> unbindDevice(DeviceUnbindReq req) {
        RequestContext context = buildContext(TruckApiEnum.UNBIND_DEVICE);
        context.setBody(JSON.toJSONString(req));
    ...
    public List<DriverListResp> driverList(DriverListReq req) {
        RequestContext context = buildContext(TruckApiEnum.DRIVER_LIST);
        context.setBody(JSON.toJSONString(req));
    ...
    public Map<String, DriverCreateResp> createDriver(DriverCreateReq req) {
        RequestContext context = buildContext(TruckApiEnum.CREATE_DRIVER);
        context.setBody(JSON.toJSONString(req));
    ...
    public DriverDeleteResp deleteDriver(DriverDeleteReq req) {
        RequestContext context = buildContext(TruckApiEnum.DELETE_DRIVER);
        context.setBody(JSON.toJSONString(req));
    ...
    public OperationDefaultResult editDriver(DriverEditReq req) {
        RequestContext context = buildContext(TruckApiEnum.EDIT_DRIVER);
        context.setBody(JSON.toJSONString(req));
    ...
    public OperationDefaultResult bindDriver(DriverBindReq req) {
        RequestContext context = buildContext(TruckApiEnum.BIND_DRIVER);
        context.setBody(JSON.toJSONString(req));
        Type type = new TypeReference<G7OpenapiResult<OperationDefaultResult>>() {}.getType();
        return this.request.request(context, type);
    }
    ...
    public SubOrgansGetAllResp getAllSubOrgans(SubOrgansGetAllReq req) {
        RequestContext context = buildContext(TruckApiEnum.GET_ALL_SUBORGANS);
    ...
    public Map<String, OrgGetByCodeResp> getOrgByCode(OrgGetByCodeReq req) {
        RequestContext context = buildContext(TruckApiEnum.GET_ORG_BY_CODE);
        context.setBody(JSON.toJSONString(req));
    ...
    public OrgRoleGetAllResp getAllRoleByOrgCode(OrgRoleGetAllReq req) {
        RequestContext context = buildContext(TruckApiEnum.GET_ALL_BY_ORGCODE);
        Map<String, String> query = new HashMap<>(3);
        //参数判断
        AssertUtil.notNull(req);
        query.put("orgcode", req.getOrgcode());
    ...
    public MarkerCreatResp markerCreat(MarkerCreatOrUpdateReq req) {
        RequestContext context = buildContext(TruckApiEnum.MARKER_CREATE);
        context.setBody(JSON.toJSONString(req));
    ...
    public MarkerDeleteResp markerDelete(MarkerDeleteReq req) {
        RequestContext context = buildContext(TruckApiEnum.MARKER_DELETE);
        context.setBody(JSON.toJSONString(req));
    ...
    public MarkerUpdateResp markerUpdate(MarkerCreatOrUpdateReq req) {
        RequestContext context = buildContext(TruckApiEnum.MARKER_UPDATE);
        context.setBody(JSON.toJSONString(req));
    ...
    public TruckCurrentLocationResp truckCurrentLocation(TruckCurrentLocationReq req) {
        RequestContext context = buildContext(TruckApiEnum.TRUCK_CURRENT_LOCATION);
        Map<String, String> query = new HashMap<>(2);
        //参数判断
        AssertUtil.notNull(req);
    ...
    public TruckCurrentInfoResp truckCurrentInfo(TruckCurrentInfoReq req) {
        RequestContext context = buildContext(TruckApiEnum.TRUCK_CURRENT_INFO);
        Map<String, String> query = new HashMap<>(3);
        //参数判断
        AssertUtil.notNull(req);
        //请求参数
    ...
    public List<TruckHistoryLocationResp> truckHistoryLocation(TruckHistoryLocationReq req) {
        RequestContext context = buildContext(TruckApiEnum.TRUCK_HISTORY_LOCATION);
    ...
    public TruckMileageResp truckMileage(TruckMileageReq req) {
        RequestContext context = buildContext(TruckApiEnum.TRUCK_MILEAGE);
        Map<String, String> query = new HashMap<>(3);
        //参数判断
        AssertUtil.notNull(req);
        //请求参数
    ...
    public EventQueryResp queryEvent(EventQueryReq req) {
        RequestContext context = buildContext(TruckApiEnum.QUERY_EVENT);
        context.setBody(JSON.toJSONString(req));
    ...
    public TruckCurrentInfoResp currentInfoByGpsNo(CurrentInfoByGpsNoReq req) {
        RequestContext context = buildContext(TruckApiEnum.CURRENT_INFO_BY_GPSNO);
        Map<String, String> query = new HashMap<>(3);
        //参数判断
        AssertUtil.notNull(req);
    ...
    public List<VideoRealTimeUrlResp> videoRealTimeUrl(String req) {
        RequestContext context = buildContext(TruckApiEnum.REAL_TIME_URL);
    ...
    public List<TruckHistoryLocationResp> truckHistoryLocationByGpsNo(TruckHistoryLocationByGpsNoReq req) {
        RequestContext context = buildContext(TruckApiEnum.TRUCK_HISTORY_LOCATION_BY_GPSNO);
        Map<String, String> query = new HashMap<>(5);
        //参数判断
        AssertUtil.notNull(req);
        //请求参数
    ...
    public DailyTemperatureResp dailyTemperature(DailyTemperatureReq req) {
        RequestContext context = buildContext(TruckApiEnum.DAILY_TEMPERATURE);
    ...
    public List<RealTimeVideoResp> realTimeByCarNum(RealTimeVideoReq req) {
        RequestContext context = buildContext(TruckApiEnum.REAL_TIME_BY_CAR_NUM);
        Map<String, String> query = new HashMap<>(5);
        //参数判断
        AssertUtil.notNull(req);
        //请求参数
    ...
    public FaceUserResp faceUserCreate(FaceUserCreateReq req) {
        RequestContext context = buildContext(TruckApiEnum.FACE_DETECT_USER_CREATE);
        AssertUtil.notNull(req);
    ...
    public FaceUserResp faceUserUpdate(FaceUserUpdateReq req) {
        RequestContext context = buildContext(TruckApiEnum.FACE_DETECT_USER_UPDATE);
        AssertUtil.notNull(req);
    ...
    public FaceUserResp faceUserDelete(FaceUserDeleteOrQueryReq req) {
        RequestContext context = buildContext(TruckApiEnum.FACE_DETECT_USER_DELETE);
        AssertUtil.notNull(req);
    ...
    public FaceUserResp faceUserQuery(FaceUserDeleteOrQueryReq req) {
        RequestContext context = buildContext(TruckApiEnum.FACE_DETECT_USER_QUERY);
        AssertUtil.notNull(req);
    ...
    public List<FaceTruckLabel> faceTruckLabelSave(FaceTruckLabelCreateReq req) {
        RequestContext context = buildContext(TruckApiEnum.FACE_DETECT_TRUCK_LABEL_SAVE);
        AssertUtil.notNull(req);
    ...
    public Void faceTruckLabelDelete(FaceTruckLabelDeleteOrQueryReq req) {
        RequestContext context = buildContext(TruckApiEnum.FACE_DETECT_TRUCK_LABEL_DELETE);
        AssertUtil.notNull(req);
    ...
    public List<FaceTruckLabel> faceTruckLabelQuery(FaceTruckLabelDeleteOrQueryReq req) {
        RequestContext context = buildContext(TruckApiEnum.FACE_DETECT_TRUCK_LABEL_QUERY);
        AssertUtil.notNull(req);
    ...
    public List<MsgCommonVoiceSendResp> batchSendVoice(List<MsgBatchSendVoiceReq> req) {
        RequestContext context = buildContext(TruckApiEnum.BATCH_SEND_VOICE);
        AssertUtil.notNull(req);
        context.setBody(JSON.toJSONString(req));
    ...
    public Object batchSendVoiceIntercom(Map<String,String> query) {
        RequestContext context = buildContext(TruckApiEnum.VOICE_INTERCOM);
    ...
    public MessageSendResultResp messageSendResult(String messageId) {
        RequestContext context = buildContext(TruckApiEnum.MESSAGE_SEND_RESULT);
