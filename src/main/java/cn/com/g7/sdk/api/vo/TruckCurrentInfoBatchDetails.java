 ...
 */
public class TruckCurrentInfoBatchDetails {
    ...
    public TruckCurrentInfoBatchDetails setGpsno(String gpsno) {
        this.gpsno = gpsno;
        return this;
    }
    ...
    public TruckCurrentInfoBatchDetails setTime(String time) {
        this.time = time;
        return this;
    }
    ...
    public TruckCurrentInfoBatchDetails setGpsStatus(String gpsStatus) {
    ...
    public TruckCurrentInfoBatchDetails setLoc(TruckCurrentInfoLoc loc) {
        this.loc = loc;
        return this;
    }
    ...
    public TruckCurrentInfoBatchDetails setStatus(TruckCurrentInfoStatus status) {
        this.status = status;
        return this;
    }
    ...
    public TruckCurrentInfoBatchDetails setCold(TruckCurrentInfoCold cold) {
        this.cold = cold;
        return this;
    }
    ...
    public TruckCurrentInfoBatchDetails setDriver(TruckCurrentInfoDriver driver) {
        this.driver = driver;
        return this;
    }
}
